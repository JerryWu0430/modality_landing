        ...
        <>
            ...
            <main className="overflow-hidden relative">
                <div className="absolute inset-0 z-0">
                    <Orb hue={360} hoverIntensity={0.2} rotateOnHover={true} />
                </div>
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    ...
                                    <p
                                        ...
                                        No models, no shoots, no delays. Generate stunning photos and videos of your products on real-looking people — in seconds.
                                    </p>
